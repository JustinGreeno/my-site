...
(function () {
  ...
  const INDEX = [
    ...
    { title: 'Games',                        page: 'games.html',     section: 'Play',         kw: 'games snake pacman colour code tetris minesweeper mines browser web games play interactive fun leaderboard high scores' },
    { title: 'Minesweeper',                  page: 'games.html',     section: 'Play',         kw: 'minesweeper mines logic puzzle grid flags beginner intermediate expert best time leaderboard browser game' },
